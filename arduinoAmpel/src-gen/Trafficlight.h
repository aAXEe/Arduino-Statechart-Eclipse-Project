...
typedef struct {
	...
	sc_boolean Trafficlight_main_region_on_r1_PedestrianRed_time_event_0_raised;
...
extern sc_boolean trafficlightIfacePedestrianLight_get_wait(Trafficlight* handle);
