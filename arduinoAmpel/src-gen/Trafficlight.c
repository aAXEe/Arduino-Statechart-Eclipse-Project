						...
						/* 'default' enter sequence for region r1 */
						{
							/* Default react sequence for initial entry  */
							{
								/* 'default' enter sequence for state PedestrianRed */
								{
									...
									trafficlight_setTimer( (sc_eventid) &(handle->timeEvents.Trafficlight_main_region_on_r1_PedestrianRed_time_event_0_raised) , 500, bool_false);
				...
				case Trafficlight_main_region_on_r1_PedestrianRed : {
					{
						...
						handle->stateConfVectorPosition = 0;
						{
							...
							trafficlight_unsetTimer( (sc_eventid) &(handle->timeEvents.Trafficlight_main_region_on_r1_PedestrianRed_time_event_0_raised) );		
						}
					}
					break;
				}
...
static void clearInEvents(Trafficlight* handle) {
	...
	handle->timeEvents.Trafficlight_main_region_on_r1_PedestrianRed_time_event_0_raised = bool_false; 
...
sc_boolean trafficlight_isActive(Trafficlight* handle, TrafficlightStates state) {
	switch (state) {
		...
		case Trafficlight_main_region_on_r1_PedestrianRed : 
			return (sc_boolean) (handle->stateConfVector[0] == Trafficlight_main_region_on_r1_PedestrianRed
			);
		case Trafficlight_main_region_on_r1_StreetAttention : 
...
sc_boolean trafficlightIfacePedestrianLight_get_wait(Trafficlight* handle) {
...
static void trafficlight_react_main_region_on_r1_PedestrianRed(Trafficlight* handle) {
	{
		...
		if (handle->iface.onOff_raised) { 
			...
			if (handle->timeEvents.Trafficlight_main_region_on_r1_PedestrianRed_time_event_0_raised) { 
				{
					/* Default exit sequence for state PedestrianRed */
					handle->stateConfVector[0] = Trafficlight_last_state;
					handle->stateConfVectorPosition = 0;
